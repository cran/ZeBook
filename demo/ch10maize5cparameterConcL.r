...
# 2) Use supplementary data with concentrate likelihood.
...
data.frame(param_opti=c("RUE", "RUE&TTM", "RUE&TTM&alpha"),AIC=c(AIC_LAI_ConcL1p["AICcomplete"],AIC_LAI_ConcL2p["AICcomplete"],AIC_LAI_ConcL3p["AICcomplete"]))
# end of script